...
<template>
    <section class="flex flex-col gap-8 items-center">
        ...
        <div class="flex gap-4 max-h-200 w-full">
            <div class="flex flex-col gap-4 w-1/2">
                <div class="flex flex-col text-end shadow-2xl px-8 cursor-pointer hover:shadow-xl">
                    <img src="../assets/category_1.svg" alt="category" class="w-fit">
                    <span>Laptops</span>
                    <span class="text-4xl">
                        True laptops<br> solution
                    </span>
                </div>
                <div class="flex text-end shadow-2xl px-8 min-h-0 items-center cursor-pointer hover:shadow-xl">
            ...
            <div class="w-[312px] shadow-2xl flex flex-col gap-4 justify-center cursor-pointer hover:shadow-xl">
